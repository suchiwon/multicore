#!/bin/bash
export MY_DB_PATH=$HOME/TA_multicore/2016_ITE4065_2011003155/Project3/mariadb/run
export MY_DB_DOC_PATH=$HOME/TA_multicore/2016_ITE4065_2011003155/Project3/mariadb/run/doc
export MY_DB_VAR_PATH=$HOME/TA_multicore/2016_ITE4065_2011003155/Project3/mariadb/run/var
cmake \
